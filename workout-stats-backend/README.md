...
To start the backend locally, run `sls offline start`.

This repo is built starting from the serverless template using Flask and DynamoDB on AWS. Boilerplate readme below.
